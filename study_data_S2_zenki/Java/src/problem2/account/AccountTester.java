...
public class AccountTester {
	...
	public static void main(String[] args) {
		...
		accounts[0] = new TimeAccount("足立幸一",1000,30);
		accounts[1] = new TimeAccount("中田幸一",200,10);
		accounts[2] = new Account("松井秀喜",80);
		accounts[3] = new Account("安倍晋三",1000);
		accounts[4] = new Account("松坂大輔",3000);
